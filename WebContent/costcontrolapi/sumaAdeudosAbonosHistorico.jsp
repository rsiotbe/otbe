...
*/           
   ...
   //strQuery = strQuery + " and fecha_oprcn_dif >= to_date('2016-08-01','yyyy-mm-dd')";  
   //String strRestrictorApuntes = " and ind_accion <> 3 and ind_2 in ('S','N','O') and cod_numrco_moneda = '978' ";
