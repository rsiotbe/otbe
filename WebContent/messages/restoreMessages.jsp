...
<%
	pLog.info("Messages ::: restoreMessages ::: Start");
	JSONObject pJsonResponse = new JSONObject();
	response.setHeader("content-type", "application/json");

	String strCodNrbe =  request.getParameter("codNrbe");
	JSONArray pJsonResult = null;
	pJsonResponse.put("restoreMessages", pJsonResult);
	%><%=Utils.generateWSResponseJsonOk("restoreMessages", pJsonResponse.toString())%>
<%!

String strErrorCode = "errorCode";
String strErrorMessage = "errorMessage";
Logger pLog = LoggerFactory.getLogger("restoreMessages.jsp");
