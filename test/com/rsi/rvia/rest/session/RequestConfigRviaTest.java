...
public class RequestConfigRviaTest extends TestBase
{
    ...
    {
        RequestConfig sessionRviaStrs = new RequestConfig(Constants.DEFAULT_LANGUAGE.name(), "MOCKED NRBE");
    ...
    {
        Language pLanguage = sessionRvia.getLanguage();
        assertNotNull("testGetLanguage: language es null", pLanguage);
        assertTrue("testGetLanguage: language no es instancia de Language", pLanguage instanceof Language);
    }
