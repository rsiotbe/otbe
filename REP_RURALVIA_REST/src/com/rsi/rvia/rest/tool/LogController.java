...
public class LogController
{
	...
	private final String PATH_LOG_FILE = "D:" + File.separator + "logs" + File.separator + "log_rest.xhtml";
	...
	public void addLog(String strTypeLog, String strLog){
		Date pDate = new Date();
		String strFinalLog = "<log> Date: " + pHourdateFormat.format(pDate) + " -- Type: " + strTypeLog + " -- Log: " + strLog + "</log>\r\n";
		File pDir = new File(PATH_LOG_FOLDER);
		...
		try
		{
			...
			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(
			        new FileOutputStream(pFile, true), "UTF-8"));;
