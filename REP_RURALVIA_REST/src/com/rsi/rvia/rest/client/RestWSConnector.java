...
public class RestWSConnector
{
	...
	private static Response rviaPost(@Context HttpServletRequest pRequest, String strComponentType, String strEndPoint,
			int nIdMiq, SessionRviaData pSessionRvia, String strData) throws Exception
	{
		Client pClient = CustomRSIClient.getClient();
