...
public class DomiciliacionRcbo
{
     ...
     * "application/x-ms-application" }) public Response listaDeContratos(@Context HttpServletRequest pRequest, @Context
     * UriInfo pUriInfo, String strData) throws Exception { // return Response.ok("Lista de contratos").build();
     * Response pReturn = OperationManager.processDataFromRvia(pRequest, pUriInfo, "{}", MediaType.TEXT_HTML_TYPE);
     * pLog.info("Lista de contratos"); return pReturn; }
     */
    @GET
    @Path("/contracts")
     ...
     * @Produces({ MediaType.TEXT_HTML })
     * @Consumes({ MediaType.APPLICATION_XHTML_XML, MediaType.TEXT_HTML, MediaType.APPLICATION_FORM_URLENCODED,
     * "application/x-ms-application" }) public Response listaDeEmisores(@Context HttpServletRequest pRequest, @Context
     * UriInfo pUriInfo, String strData) throws Exception { // return Response.ok("Lista de contratos").build();
     * Response pReturn = OperationManager.processDataFromRvia(pRequest, pUriInfo, "{}",
     * MediaType.APPLICATION_JSON_TYPE); pLog.info("Lista de contratos"); return pReturn; }
     */
    /**
