...
public class ManageJWToken
{
     ...
     */
    private static void prepareRsaJsonWebKey(String strTokenId) throws JoseException, NoSuchAlgorithmException,
            InvalidKeySpecException, IOException
    {
        ...
        rsaJsonWebKey.setKeyId(strTokenId);
     ...
     */
    public static String generateJWT(HashMap<String, String> fields, String strTokenId) throws JoseException,
            NoSuchAlgorithmException, InvalidKeySpecException, IOException
    {
        // Cargamos clave privada y generamos clave pública
        prepareRsaJsonWebKey(strTokenId);
     ...
     */
    public static HashMap<String, String> validateJWT(String jwt, String strTokenId) throws MalformedClaimException,
            NoSuchAlgorithmException, InvalidKeySpecException, JoseException, IOException
    {
        ...
        .setAllowedClockSkewInSeconds(30) // allow some leeway in validating time based claims to account for clock
                                          // skew
        ...
        try
        {
            ...
            HashMap<String, String> claims = JwtClaimsToHashMap(jwtClaims);
            long exp = jwtClaims.getExpirationTime().getValueInMillis();
            long iat = jwtClaims.getIssuedAt().getValueInMillis();
            if ((exp - iat) < 120 * 1000)
            {
                String newJWT = generateJWT(claims, strTokenId);
