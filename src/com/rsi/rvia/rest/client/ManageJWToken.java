...
public class ManageJWToken
{
    ...
    */
   private static void prepareRsaJsonWebKey()
    ...
    */
   public static String generateJWT(HashMap<String, String> fields)
         throws JoseException, NoSuchAlgorithmException, InvalidKeySpecException, IOException
   {
   ...
   public static HashMap<String, String> validateJWT(String jwt)
         throws MalformedClaimException, NoSuchAlgorithmException, InvalidKeySpecException, JoseException, IOException
   {
