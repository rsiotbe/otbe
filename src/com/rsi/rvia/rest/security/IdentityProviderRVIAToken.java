 ...
 *        de Ruralvía
 */
public class IdentityProviderRVIAToken implements IdentityProvider
{
    private static Logger           pLog = LoggerFactory.getLogger(IdentityProviderRVIAToken.class);
    ...
    public IdentityProviderRVIAToken(HttpServletRequest pRequest, MiqQuests pMiqQuests)
    {
        _pRequest = pRequest;
