...
public class RequestConfigRvia extends RequestConfig
{
    ...
    {
        NODE("node"),
        RVIASESION("RVIASESION"),
        ISUMUSERPROFILE("isumUserProfile"),
    ...
    public RequestConfigRvia(HttpServletRequest request) throws Exception
    {
        ...
        {
            throw new SessionException(500, 999999, "Error al obtener datos de sesion desde Ruralvia", strIsumServiceId,
                    ex);
        }
    }
    ...
    private void loadProperties() throws Exception
    {
        try
        {
            ...
            {
                pLog.error(
                        "No se ha podido leer el parámetro nodo de ruralvia, esto va a generar un error al obtener el nodo origen de la petición");
            }
