...
public class RestConnector
{
     ...
     * @throws Exception
     */
    public Response getData(HttpServletRequest pRequest, RequestConfig pRequestConfig,
            MiqQuests pMiqQuests, MultivaluedMap<String, String> pPathParams, WSObject wsObject)
            throws Exception
    {
        Response pReturn = null;
        String strMethod = pRequest.getMethod();
        String strData = wsObject.toJSONString();
        ...
        {
            case RVIA:
                pReturn = RestRviaConnector.doConnection(pRequest, pMiqQuests, (RequestConfigRvia) pRequestConfig, strData, pPathParams, null);
                break;
            case COORD:
                pReturn = RestRviaConnector.doDirectConnectionToJsp(pRequest, pMiqQuests, (RequestConfigRvia) pRequestConfig, strData, pPathParams, null);
                break;
            case WS:
            case API:
            case SIMULATOR:
                ...
                {
                    case "GET":
                        pReturn = RestWSConnector.get(pRequest, pMiqQuests, pPathParams, wsObject);
                        break;
                    case "POST":
                        pReturn = RestWSConnector.post(pRequest, pMiqQuests, pRequestConfig, strData, pPathParams, null);
                        break;
                    case "PUT":
                        pReturn = RestWSConnector.put(pRequest, pMiqQuests, pRequestConfig, strData, pPathParams, null);
                        break;
                    case "PATCH":
                        pLog.warn("No existe ninguna acción para este método");
                        break;
