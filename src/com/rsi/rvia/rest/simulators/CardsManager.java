...
public class CardsManager
{
    ...
    public static RviaRestResponse getAllCards(String strIdNRBE, Language pLanguage, String strNRBE) throws Exception
    {
        ...
        try
        {
            ...
            strJson = "{\"nrbe\" : \"" + strIdNRBE + "\", \"nrbeName\" : \"" + strNRBE
                    + "\", \"active\" : true, \"tarjetas\" : [" + strJson + "]}";
        ...
        catch (SQLException ex)
        {
            ...
            /*
             * RviaRestResponseErrorItem pRviaRestResponseErrorItem = new RviaRestResponseErrorItem("999",
             * ex.getMessage()); pRviaRestResponse = new RviaRestResponse(RviaRestResponse.Type.ERROR, null,
             * pRviaRestResponseErrorItem);
             */
            throw ex;
        }
        finally
