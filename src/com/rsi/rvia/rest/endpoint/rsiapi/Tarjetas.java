...
import com.rsi.rvia.rest.endpoint.rsiapi.MovimientosContrato;
...
public class Tarjetas
{
	...
	/**
	 * Obtiene el detalle de movimientos para todos los contratos de tarjetas de una categoría en el mes. En el documento
	 * WebService6b
	 * 
	 * @return Objeto que contiene la respuesta y en caso positivo se adjunta el listado de tarjetas
	 * @throws Exception
	...
	/**
	 * Obtiene el detalle de movimientos para todos los contratos de tarjetas en una localidad en el mes. En el documento
	 * WebService6b
	 * 
	 * @return Objeto que contiene la respuesta y en caso positivo se adjunta el listado de tarjetas
	 * @throws Exception
	...
	/**
	 * Obtiene el detalle de movimientos para todos los contratos de tarjetas para un comercio en el mes. En el documento
	 * WebService6b
	 * 
	 * @return Objeto que contiene la respuesta y en caso positivo se adjunta el listado de tarjetas
	 * @throws Exception
	...
	/**
	 * Obtiene un agregado de movimientos en tarjetas por el concepto especificado (categoria,localidad,comercio), y a
	 * partir de una fecha, hasta última fecha desponible. Movimientos históricos en tarjetas En el documento WebService7
	 * 
	 * @return Objeto que contiene la respuesta y en caso positivo se adjunta el listado de tarjetas
	 * @throws Exception
	 */
	...
	/**
	 * Obtiene un agregado de movimientos de una tarjeta por el concepto especificado (categoria,localidad,comercio), y a
	 * partir de una fecha, hasta última fecha desponible. Movimientos históricos en tarjetas En el documento WebService7
	 * 
	 * @return Objeto que contiene la respuesta y en caso positivo se adjunta el listado de tarjetas
	 * @throws Exception
