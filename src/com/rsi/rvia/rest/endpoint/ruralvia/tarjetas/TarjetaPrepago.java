...
public class TarjetaPrepago
{
    ...
    {
        pLog.info("Se obtienen el listado de tarjetas prepago disponibles HTML.");
        Response pReturn = OperationManager.processDataFromRvia(pRequest, pUriInfo, "{}", MediaType.TEXT_HTML_TYPE);
        pLog.info("Se finaliza la obtencion de el listado de tarjetas prepago disponibles HTML.");
        return pReturn;
    }
