...
public class CostControl
{
   ...
   /**
    * Detalle de movimientos para una acuerdo, mes, y tipo entre haber y debe Adeudos y abonos históricos para un
    * aucerdo - detalle En el documento WebService3
    * 
    * @return Objeto que contiene la respuesta y en caso positivo se adjunta el listado de tarjetas
    * @throws Exception
    */
    ...
    * )
    * @Produces(MediaType.APPLICATION_JSON) public Response detalleMovimientos(@Context HttpServletRequest
    * pRequest, @Context UriInfo pUriInfo, String strData) throws Exception { Response pReturn =
