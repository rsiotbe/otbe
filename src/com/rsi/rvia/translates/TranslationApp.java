...
public class TranslationApp
{
    ...
    public String getTranslation(String strCode, Language pLanguage)
    {
        if (htTranslatesCodes.get(strCode) != null)
            return htTranslatesCodes.get(strCode).getTranslation(pLanguage);
        else
            return null;
    }
    ...
    public boolean existTranslationInLanguaje(String strCode, Language pLanguage)
    {
        return (htTranslatesCodes.containsKey(strCode) && (this.getTranslation(strCode, pLanguage) != null));
    }
